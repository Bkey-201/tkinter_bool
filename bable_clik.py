...
class App(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.title("Удаление элементов холста Bkey-201")

        self.canvas = tk.Canvas(self, bg="white")
        frame1 = tk.frame1(self)
        generate_btn = tk.Button(frame1, text="Создавать элементы",
                                 command=self.generate_items)
        clear_btn = tk.Button(frame1, text="Удалить элементы",
